const tutos = [
 ...
 <h3 style = 'text-align:center'>Corte do Vazio:</h3><Br>
    ...
    {id:2, name: 'coletaveis',
        ...
        <div class="tutodiv">
        <img src='./public/sources/objects/feather.png' class='tutoimg'> <p>E quem disse que gato não voa? daonde essa pena surgiu certamente você não vai querer saber, o que importa, é que ao coleta-la, o gato terá sua queda automatica cancelada por 10s, possibilitando ao nosso felino um livre arbitrio aos céus, podendo descer para o chão apenas usando o derrape.<br> Cuidado, caso o gato sofra algum dano, o gato tera suas "asinhas" cortadas.</p></div><br>
